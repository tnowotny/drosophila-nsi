...
dv_b/dt = (gl_b*(El-v_b)-
         ...
         g_M*SA_ratio*M_b*(v_b-EK)+g_01_b*(v1_b-v_b)+
         I_off_b+I_noise_b*xi_b)/Cm_b : volt
dv1_b/dt = (g_01_b*(v_b-v1_b)-g_r*SA_ratio*s_r_b*(v1_b-ENa-v_sl))/Cm1_b : volt
...
dv_sl/dt = (gl_sl*(El_sl-v_sl)+g_r*s_r_a*(v1_a-ENa-v_sl)+g_r*SA_ratio*s_r_b*(v1_b-ENa-v_sl))/Cm_sl : volt
pM1: 1 (constant)
pM2: volt (constant)
pM3: volt (constant)
pM4: 1 (constant)
